...
app.get('/home',admincontroller.isAuth,admincontroller.isAdmin,admincontroller.home)
app.get('/adminEdit/:id',admincontroller.isAuth,admincontroller.editUser)
app.post('/userEdit',admincontroller.preventCache,admincontroller.userEdit)
